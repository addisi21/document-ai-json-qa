...
- [data/extraction_batch_sample.json](data/extraction_batch_sample.json): public batch extraction sample with intentional QA issues
- [scripts/audit_extraction_batch.py](scripts/audit_extraction_batch.py): dependency-free batch data-quality audit script
- [outputs/batch-quality-report.md](outputs/batch-quality-report.md): generated batch QA report with severity counts
...
python scripts/audit_extraction_batch.py
```
